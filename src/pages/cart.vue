          ...
          <ul class="cart-item-list">
            ...
            <li class="cart-item" v-for="(item,index) in list" v-bind:key="index">
              <div class="item-check">
                <!-- v-bind动态绑定span标签的class值 如果商品被选中 则item.productSelected为true 则将class设置成checked -->
  ...
  export default{
    ...
    methods:{
      ...
      renderData(res){
        ...
        // 利用过滤器判断已经被选中的商品数量 返回item.productSelected为true的数据长度
        this.checkedNum = this.list.filter(item=>item.productSelected).length;
      },
      // 购物车下单
      order(){
        // every()可以表示数组中的每一项都要符合条件 
        ...
        .wrapper{
            ...
            .cart-box{
                ...
                .checkbox{
                    ...
                    margin-right: 17px;
                    &.checked{
                        background:url('D:/study/前端/mimall/public/imgs/icon-gou.png') #FF6600 no-repeat center;
                ...
                .cart-item-list{
                    .cart-item{
                        ...
                        .item-del{
                            ...
                            width:14px;
                            height:12px;
                            background:url('D:/study/前端/mimall/public/imgs/icon-close.png') no-repeat center;
