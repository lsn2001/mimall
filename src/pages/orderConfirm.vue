                ...
                <div class="action">
                  ...
                  <a href="javascript:;" class="fr" @click="editAddressModal(item)">
                    <svg class="icon icon-edit">
                      <!-- svg图片使用 需要svg的图片id 再用xlink:href='# + id名' -->
    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          ...
          <div class="item">
            <textarea name="street" v-model="checkedItem.receiverAddress" placeholder="请填写地址"></textarea>
          </div>
          <div class="item">
  ...
  methods:{
    ...
    getCartList(){
      this.axios.get('/carts').then((res)=>{
        ...
        // 遍历选中每个商品的件数 再进行累加 得到选中商品的总件数 map将现有数组转换成新数组 
          ...
          .addr-list{
            ...
            .addr-add{
              ...
              .icon-add{
                ...
                height:30px;
                border-radius:50%;
                background:url('D:/study/前端/mimall/public/imgs/icon-add.png') #E0E0E0 no-repeat center;
