...
export default {
  ...
  methods:{
    login(){
      // username,password是在vue对象当中的  可以使用解构的方法获取当前的username和password
      ...
      this.axios.post('/user/login',{
        // key和value相同 所以可以直接写username 不然需要写username:变量名
        username,
        password
      }).then((res)=>{
...
.login{
  ...
  .wrapper{
    background:url('D:/study/前端/mimall/public/imgs/login-bg.jpg') no-repeat center;
    .container{
      height:576px;
      .login-form{
